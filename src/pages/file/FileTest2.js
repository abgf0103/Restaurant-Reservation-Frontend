...
const FileTest2 = () =>{
    ...
    const handleFileUpload = () => {
        ...
        instance.post('/file/save', formData, {
            headers: {
                ...
                {fileList.map((item) => {
                    return( 
                        ...
                        <img 
                            ...
                            key={item.id}
                            style={{width:"100px"}}/>
                            <button type="button" onClick={()=> fileDelete(item.id, item.fileTarget)}>삭제</button>
                        </>
                    )
                })}
