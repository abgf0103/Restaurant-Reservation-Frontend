        ...
        <div>
            ...
            <Form onSubmit={requestStoreRegister}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" placeholder="가게 이름을 입력하세요" name='storeName' onChange={onChangeHandler}/>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Select name='category' onChange={storeCategoryHandler} value={storeCategory}>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control placeholder="주소를 입력하세요" name='address'onChange={onChangeHandler}/>
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>영업시간 (ex/17:00~23:00)</Form.Label>
                    <Form.Control placeholder="영업시간을 입력하세요" name='storeHours'onChange={onChangeHandler}/>
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>연락처</Form.Label>
                    <Form.Control placeholder="연락처를 입력하세요" name='phone'onChange={onChangeHandler}/>
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>가게 소개</Form.Label>
                    <Form.Control as="textarea" rows={4} placeholder="소개글을 입력하세요" name='description' onChange={onChangeHandler}/>
                </Form.Group>
