  ...
  const handleInfoClick = () => {
    Swal.fire({
      ...
      html: `
        ...
        <p><strong>현재 내 랭킹:</strong> ${
          ranking ? ranking + "등" : "불러오는 중..."
        }</p>
        <br />
        
       <p><em>참고:</em></p>
        <p><strong>현재 사용자 랭킹</strong>: <strong>내</strong>  리뷰에 달린 <strong>좋아요 수</strong>를 기준으로 순위가 매겨집니다.
        <strong>내가 작성한 모든 리뷰에서 받은 좋아요 수 총합</strong>을 반영하여, 다른 사용자들과의 비교를 통해 순위가 결정됩니다.</p>
      `,
