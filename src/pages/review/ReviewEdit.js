...
const ReviewEdit = () => {
                    ...
                    .then((res) => {
                        if (res.status === 200) {
                            ...
                            setReview((prevReview) => {
                                const updatedFiles = prevReview.files.filter((item) => item.id !== file.id);
    ...
    const handleFileChange = (e) => {
        setSelectedFiles((prevState) => [...prevState, ...Array.from(e.target.files)]);
    };
    ...
    // 빈별 svg
    const EmptyStar = () => (
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="" viewBox="0 0 16 16">
                ...
                <Col md={8}>
                    <Card className="shadow-lg p-4">
                        ...
                        <Form onSubmit={handleSubmit}>
                            ...
                            <ReviewCommentFormGroup controlId="reviewComment" className="mb-4">
                                {/* 파일 첨부 부분 */}
                            ...
                            <SubmitButton variant="danger" type="submit" className="submit-button">
                                리뷰 수정
                            </SubmitButton>
                        </Form>
                    </Card>
